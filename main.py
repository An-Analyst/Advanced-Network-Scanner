...
class AboutDialog(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.title("About ANS")
        self.resizable(False, False)
        self.geometry("400x300+240+240")

        # create widgets
        label_version = tk.Label(self, text=f"ANS Version {version}", font=("TkDefaultFont", 12, "bold"))
        label_version.pack(pady=10)

        label_description = tk.Label(self,
                                     text=f"ANS {version} provides a graphical user interface\n solution for running "
                                          f"nmap scans in Linux.",
                                     justify="center")
        label_description.pack(pady=10)

        label_author = tk.Label(self, text="Author: Amol Bhalerao", font=("TkDefaultFont", 10))
        label_author.pack()

        label_github = tk.Label(self, text="GitHub: https://github.com/An-Analyst/Advanced-Network-Scanner/", font=("TkDefaultFont", 10),
        ...
        label_license_github = tk.Label(self, text="https://github.com/An-Analyst/Advanced-Network-Scanner",
    ...
    def on_github_clicked(self, event):
        webbrowser.open_new("https://github.com/An-Analyst/Advanced-Network-Scanner")
